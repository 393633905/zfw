...
@section('cnt')
    ...
    <article class="page-container">
        ...
        <form action="{{ route('admin.article.update',$article) }}" class="form form-horizontal" @submit.prevent="addArticle">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-4 col-sm-7">
                    <img src="{{$article->pic}}" id="img" style="width: 100px; height: 80px">
                </div>
            </div>
            <div class="row cl">
